    ...
    return (
        <section id="hero" className="hero-section bg-[#DDA853]">
            <div className="container mx-auto px-4 md:px-12 flex flex-col items-center justify-center min-h-screen pt-20 pb-10">
                {/* Image on top for smaller screens, side by side on larger screens */}
                <div className="w-full flex flex-col lg:flex-row items-center">
                    ...
                    <motion.div
                        className="w-full lg:w-1/2 lg:order-1 text-center lg:text-left lg:pr-8"
                        initial={{ opacity: 0, x: -50 }}
                        animate={{ opacity: 1, x: 0 }}
                        transition={{ duration: 0.8 }}
                    >
                        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 break-words sm:whitespace-nowrap">
